...
module.exports = {
    ...
    setDeviceSlogan: location.setDeviceSlogan,
    getDeviceSlogan: location.getDeviceSlogan,
    getDeviceSecurityStatus: location.getDeviceSecurityStatus,
    getAllowedDeviceList: location.getAllowedDeviceList
};
