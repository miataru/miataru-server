...
var RequestGetDeviceSecurityStatus = require('../../../models/RequestGetDeviceSecurityStatus');
var RequestGetAllowedDeviceList = require('../../../models/RequestGetAllowedDeviceList');
    ...
    try {
        switch(req.path) {
            ...
            case '/v1/getDeviceSlogan':
                ...
                break;
            case '/getDeviceSecurityStatus':
            case '/v1/getDeviceSecurityStatus':
                parseGetDeviceSecurityStatus(req);
                break;
            case '/getAllowedDeviceList':
            case '/v1/getAllowedDeviceList':
                parseGetAllowedDeviceList(req);
                break;
        }
    }
    catch(error) {
...
function parseGetDeviceSecurityStatus(req) {
    req.MIATARU.request = new RequestGetDeviceSecurityStatus(req.body['MiataruGetDeviceSecurityStatus'] || {});
}

function parseGetAllowedDeviceList(req) {
    req.MIATARU.request = new RequestGetAllowedDeviceList(req.body['MiataruGetAllowedDeviceList'] || {});
}
