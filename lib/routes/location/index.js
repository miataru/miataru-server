...
module.exports.install = function(app) {
    ...
    app.post('/v1/getDeviceSecurityStatus', v1.inputParser, v1.getDeviceSecurityStatus);
    app.post('/v1/getAllowedDeviceList', v1.inputParser, v1.getAllowedDeviceList);
    ...
    app.post('/getDeviceSecurityStatus', v1.inputParser, v1.getDeviceSecurityStatus);
    app.post('/getAllowedDeviceList', v1.inputParser, v1.getAllowedDeviceList);
    ...
    app.all('/v1/getDeviceSecurityStatus', handleUnsupportedMethod);
    app.all('/v1/getAllowedDeviceList', handleUnsupportedMethod);
    ...
    app.all('/getDeviceSecurityStatus', handleUnsupportedMethod);
    app.all('/getAllowedDeviceList', handleUnsupportedMethod);
};
