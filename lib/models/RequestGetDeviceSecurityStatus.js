...
function RequestGetDeviceSecurityStatus(data) {
    data = data || {};
...
RequestGetDeviceSecurityStatus.prototype.deviceId = function() {
    return this._deviceId;
};

RequestGetDeviceSecurityStatus.prototype.requestDeviceID = function() {
    return this._requestDeviceID;
};

RequestGetDeviceSecurityStatus.prototype.requestDeviceKey = function() {
    return this._requestDeviceKey;
};

RequestGetDeviceSecurityStatus.prototype.requestVisitorObject = function(targetDeviceID) {
...
RequestGetDeviceSecurityStatus.prototype._validate = function() {
    ...
    validation.ensureDeviceIdAllowed(this._requestDeviceID, 'RequestDeviceID');
    this._requestDeviceKey = validation.normalizeRequiredDeviceKey(this._requestDeviceKey, 'RequestDeviceKey');
};

module.exports = RequestGetDeviceSecurityStatus;
