...
function RequestConfigGetLocation(data) {
    ...
    validation.ensureDeviceIdAllowed(this._requestMiataruDeviceID, 'RequestMiataruDeviceID');
    this._requestMiataruDeviceKey = validation.normalizeOptionalDeviceKey(this._requestMiataruDeviceKey, 'RequestMiataruDeviceKey');
}
