...
Most existing API 1.0 clients continue to work without modification. GetLocation/GetLocationHistory clients must include `RequestMiataruDeviceID`; other security features remain opt-in:
