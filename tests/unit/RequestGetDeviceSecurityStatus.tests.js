...
var RequestGetDeviceSecurityStatus = require('../../lib/models/RequestGetDeviceSecurityStatus');

describe('RequestGetDeviceSecurityStatus', function() {
    ...
    describe('constructor', function() {
        ...
        it('should throw BadRequestError when RequestDeviceKey is not a string', function() {
            expect(function() {
                new RequestGetDeviceSecurityStatus({
                    DeviceID: 'target-device',
                    RequestDeviceID: 'request-device',
                    RequestDeviceKey: 123
                });
            }).to.throw(errors.BadRequestError, 'RequestDeviceKey must be a string');
        });
