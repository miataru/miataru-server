...
describe('GetLocationHistory strict RequestMiataruDeviceKey validation', function() {
    var TARGET_DEVICE = 'target-history-device-' + Date.now();
    var REQUESTING_DEVICE = 'requesting-history-device-' + Date.now();
    var REQUESTING_DEVICE_KEY = 'requesting-history-device-key-123';
    ...
    function createLocationHistoryForTarget(done) {
    ...
    it('should return 403 when requesting device has DeviceKey but RequestMiataruDeviceKey is missing', function(done) {
        createLocationHistoryForTarget(function(error) {
            ...
            setRequestingDeviceKey(function(error2) {
                ...
                request(app)
                    ...
                    .send(calls.getLocationHistoryCall(TARGET_DEVICE, '25', REQUESTING_DEVICE))
                    .expect(403)
                    .expect(function(res) {
    ...
    it('should return 403 when RequestMiataruDeviceKey does not match', function(done) {
        createLocationHistoryForTarget(function(error) {
            ...
            setRequestingDeviceKey(function(error2) {
                ...
                request(app)
                    .post('/v1/GetLocationHistory')
                    .send(calls.getLocationHistoryCall(TARGET_DEVICE, '25', REQUESTING_DEVICE, 'wrong-key'))
                    .expect(403)
                    .expect(function(res) {
                        expect(res.body.error).to.include('RequestMiataruDeviceKey');
    ...
    it('should return history when RequestMiataruDeviceKey matches', function(done) {
        createLocationHistoryForTarget(function(error) {
            if (error) return done(error);
            ...
            setRequestingDeviceKey(function(error2) {
                ...
                request(app)
                    .post('/v1/GetLocationHistory')
                    .send(calls.getLocationHistoryCall(TARGET_DEVICE, '25', REQUESTING_DEVICE, REQUESTING_DEVICE_KEY))
                    .expect(200)
                    .expect(function(res) {
